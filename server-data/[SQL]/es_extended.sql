...
-- Dump dei dati della tabella es_extended.bpt_items: ~3 rows (circa)
...
-- Dump dei dati della tabella es_extended.datastore_data: ~215 rows (circa)
...
-- Dump dei dati della tabella es_extended.owned_vehicles: ~2 rows (circa)
