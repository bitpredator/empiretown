...
-- Dump dei dati della tabella es_extended.addon_account: ~11 rows (circa)
...
-- Dump dei dati della tabella es_extended.datastore: ~12 rows (circa)
...
-- Dump dei dati della tabella es_extended.jobs: ~16 rows (circa)
