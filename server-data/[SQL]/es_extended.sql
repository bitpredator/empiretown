...
-- Dump dei dati della tabella es_extended.bpt_items: ~35 rows (circa)
...
-- Dump dei dati della tabella es_extended.datastore_data: ~851 rows (circa)
...
-- Dump dei dati della tabella es_extended.job_grades: ~59 rows (circa)
