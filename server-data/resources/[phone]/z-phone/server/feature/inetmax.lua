...
lib.callback.register('z-phone:server:TopupInternetData', function(source, body)
    ...
    local content = [[
Grazie per aver scelto i nostri servizi! Siamo lieti di confermarti che l'acquisto del pacchetto dati Internet è andato a buon fine.
\
Totale: %s \
Tariffa : $%s / %sKB \
Stato : %s \
\
Il tuo pacchetto dati verrà attivato a breve e riceverai un'email con tutti i dettagli necessari. Per qualsiasi domanda o ulteriore assistenza, non esitare a contattarci.
\
