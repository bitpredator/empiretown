...
local DoesEntityExist, NetworkRequestControlOfEntity, NetworkHasControlOfEntity, DisableControlAction, HasModelLoaded, RequestModel, DisableAllControlActions, FreezeEntityPosition, SetEntityCoords, SetEntityVisible =
    DoesEntityExist, NetworkRequestControlOfEntity, NetworkHasControlOfEntity, DisableControlAction, HasModelLoaded, RequestModel, DisableAllControlActions, FreezeEntityPosition, SetEntityCoords, SetEntityVisible
                    ...
                    if element2.name == "invoice_amount" then
                        ...
                        if amount ~= nil then
                            ...
                            if closestPlayer == -1 or closestDistance > 3.0 then
                                ...
                                TriggerServerEvent("bpt_billing:sendBill", GetPlayerServerId(closestPlayer), "society_cardealer", TranslateCap("car_dealer"), amount)
                            end
                        end
                    end
                end, function(menu) end)
