...
Config.JobInteractions = {
    ...
    ["taxi"] = {
        {
            ...
            icon = "eye-slash",
            type = "client",
            event = "esx_taxi:client:toggleMeter",
            shouldClose = false,
        },
        {
            id = "togglemouse",
            ...
            type = "client",
            event = "esx_taxi:client:enableMeter",
            shouldClose = true,
        },
        {
            id = "npc_mission",
            ...
            icon = "taxi",
            type = "client",
            event = "esx_taxi:client:DoTaxiNpc",
            shouldClose = true,
        },
    },
    ["tow"] = {
        ...
        },
        {
            ...
            icon = "truck-pickup",
            type = "client",
            event = "esx_tow:client:TowVehicle",
            shouldClose = true,
        },
    },
    ["mechanic"] = {
    ...
    ["police"] = {
        ...
        },
        {
            ...
            icon = "circle-info",
            type = "client",
            event = "esx_tunerchip:client:TuneStatus",
            shouldClose = true,
        },
        {
            id = "resethouse",
            ...
            icon = "key",
            type = "client",
            event = "esx_houses:client:ResetHouse",
            shouldClose = true,
        },
        {
    ...
    ["hotdog"] = {
        {
            ...
            icon = "hotdog",
            type = "client",
            event = "esx_hotdogjob:client:ToggleSell",
            shouldClose = true,
        },
    },
}
