Config = {
    -- Menu Options
    MenuLanguage = 'it', -- Change the language of the menu here!.
    ...
    Framework = 'esx', -- Used for few framework-dependent things. Accepted values: 'qb-core', false
    ...
    MenuTitle = 'EMPIRETOWN', -- You can change the name of the menu here or leave it blank to remove the text in front of the custom banners
    TitleOutline = false,
