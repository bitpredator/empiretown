...
Config.Garage = {
    ...
    OwnedVehiclesOnly = false, -- Only allow owned vehicles to be stored Default: true
...
Config.FurnitureCatagories = {
    ...
    Sofas = { { price = 11500, title = "Couch with pillows", name = "prop_couch_01" }, { price = 6500, title = "Padded bench", name = "prop_wait_bench_01" }, { price = 4400, title = "White leather sofa", name = "xm_lab_sofa_01" } },
    Kitchen = {
