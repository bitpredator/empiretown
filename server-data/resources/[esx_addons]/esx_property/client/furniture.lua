if Config.Furniture.Enabled then
                ...
                if IsControlJustPressed(0, Config.Furniture.Controls.Confirm) then
                    if not Existing then
                        ESX.OpenContext(
                            "right",
                            {
                                { unslectable = true, title = TranslateCap("confirm_buy", Config.FurnitureCatagories[PropCatagory][PropIndex].title), description = TranslateCap("price", Config.FurnitureCatagories[PropCatagory][PropIndex].price), icon = "fas fa-shopping-cart" },
                                { title = TranslateCap("yes"), value = "buy", icon = "fas fa-check" },
                                { title = TranslateCap("no"), icon = "fas fa-minus" },
                            },
    ...
    function FurnitureItems(house, Store, StoreIndex, Catagory)
        local Items = { { unselectable = true, title = TranslateCap("store_title", Catagory), icon = "fas fa-store" }, { title = TranslateCap("back"), value = "go-back", icon = "fas fa-arrow-left" } }
    ...
    function FurnitureCatagories(house, Store, StoreIndex)
        local Catagories = { { unselectable = true, title = TranslateCap("store_title", Store), icon = "fas fa-store" }, { title = TranslateCap("back"), value = "go-back", icon = "fas fa-arrow-left" } }
    ...
    function FurnitureEdit(propertyId, furniture)
        ...
        local Catagories = {
            { unselectable = true, title = TranslateCap("edit_title", Funiture.title), icon = "fas fa-store" },
            { title = TranslateCap("back"), value = "go-back", icon = "fas fa-arrow-left" },
            { title = TranslateCap("move_title"), value = "rotate", icon = "fas fa-sync-alt" },
            { title = TranslateCap("delete_furni"), value = "delete", icon = "fas fa-trash-alt" },
        }
    ...
    function FurnitureEditSelect(propertyId)
        local Furni = { { unselectable = true, title = TranslateCap("owned_furni"), icon = "far fa-edit" }, { title = TranslateCap("back"), value = "go-back", icon = "fas fa-arrow-left" } }
    ...
    function FurnitureStores(house)
        local Options = { { unselectable = true, title = TranslateCap("menu_stores"), icon = "fas fa-store" }, { title = TranslateCap("back"), value = "go-back", icon = "fas fa-arrow-left" } }
    ...
    function FurnitureMenu(PropertyId)
        local Options = { { unselectable = true, title = TranslateCap("furni_management"), icon = "fas fa-lamp" }, { title = TranslateCap("menu_stores"), description = TranslateCap("menu_stores_desc"), icon = "fas fa-dollar-sign", value = "store" } }
