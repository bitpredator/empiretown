...
if Config.Furniture.Enabled then
				...
				if IsControlJustPressed(0, Config.Furniture.Controls.Confirm) then
					if not Existing then
						ESX.OpenContext("right", {
							{
								unslectable = true,
								title = _U("confirm_buy", Config.FurnitureCatagories[PropCatagory][PropIndex].title),
								description = _U("price", Config.FurnitureCatagories[PropCatagory][PropIndex].price),
	...
	function FurnitureItems(house, Store, StoreIndex, Catagory)
		local Items = {
			{ unselectable = true, title = _U("store_title", Catagory), icon = "fas fa-store" },
	...
	function FurnitureCatagories(house, Store, StoreIndex)
		local Catagories = {
			{ unselectable = true, title = _U("store_title", Store), icon = "fas fa-store" },
			{ title = _U("back"), value = "go-back", icon = "fas fa-arrow-left" },
		}
	...
	function FurnitureEditSelect(propertyId)
		local Furni = {
			{ unselectable = true, title = _U("owned_furni"), icon = "far fa-edit" },
			{ title = _U("back"), value = "go-back", icon = "fas fa-arrow-left" },
		}
	...
	function FurnitureStores(house)
		local Options = {
			{ unselectable = true, title = _U("menu_stores"), icon = "fas fa-store" },
			{ title = _U("back"), value = "go-back", icon = "fas fa-arrow-left" },
		}
	...
	function FurnitureMenu(PropertyId)
		local Options = {
			{ unselectable = true, title = _U("furni_management"), icon = "fas fa-lamp" },
			{
				title = _U("menu_stores"),
				description = _U("menu_stores_desc"),
		...
		if #SpawnedFurniture > 0 then
			...
			Options[#Options + 1] =
				{ title = _U("menu_edit"), description = _U("menu_edit_desc"), icon = "fas fa-archive", value = "edit" }
		end
		ESX.OpenContext("right", Options, function(data, element)
