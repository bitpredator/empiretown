...
Citizen.CreateThread(function()
	while true do
		...
		if isPedDrivingAVehicle() then
			...
			healthEngineDeltaScaled = healthEngineDelta
				* cfg.damageFactorEngine
			...
			healthPetrolTankDeltaScaled = healthPetrolTankDelta
				* cfg.damageFactorPetrolTank
				* cfg.classDamageMultiplier[vehicleClass]
			...
			if pedInSameVehicleLast == true then
				...
				if
					...
					or healthBodyCurrent ~= 1000.0
					or healthPetrolTankCurrent ~= 1000.0
				then
					...
					if
						healthEngineNew > (cfg.cascadingFailureThreshold + 5)
						and healthEngineNew < cfg.degradingFailureThreshold
					then
