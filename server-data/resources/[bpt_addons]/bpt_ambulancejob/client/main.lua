...
RegisterNetEvent("z-phone:loaded")
AddEventHandler("z-phone:loaded", function(phoneNumber, contacts)
    ...
    TriggerEvent("z-phone:addSpecialContact", specialContact.name, specialContact.number, specialContact.base64Icon)
end)
