Locales["en"] = {
    ...
    ["open_governament"] = "press [E] to access the governament.",
    ["confirm"] = "Confirm",
    -- Vehicles
    ...
    ["being_searched"] = "you are being searched by the governament",
    -- Body Search Menu
    ["guns_label"] = "--- Guns ---",
    ...
    ["inventory"] = "inventory",
    ["governament_stock"] = "governament Stock",
    -- Misc
    ["remove_prop"] = "press [E] to delete the object",
    ["map_blip"] = "governament Station",
    ["unrestrained_timer"] = "you feel your handcuffs slowly losing grip and fading away.",
    -- Notifications
    ["alert_governament"] = "governament alert",
    ["phone_governament"] = "governament",
    -- Keybind
    ["interaction"] = "Interact",
    ["quick_actions"] = "Quick Actions",
    -- Other
    ["society_governament"] = "governament",
}
