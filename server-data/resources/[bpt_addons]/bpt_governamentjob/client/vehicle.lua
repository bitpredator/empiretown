...
function OpenVehicleSpawnerMenu(type, station, part, partNum)
    ...
    ESX.OpenContext("right", elements, function(menu, element)
        if element.action == "buy_vehicle" then
            local shopElements = {}
            local shopCoords = Config.Governament[station][part][partNum].InsideShop
...
function StoreNearbyVehicle(playerCoords)
    ...
    ESX.TriggerServerCallback("bpt_governamentjob:storeNearbyVehicle", function(plate)
        if plate then
...
function GetAvailableVehicleSpawnPoint(station, part, partNum)
    local spawnPoints = Config.Governament[station][part][partNum].SpawnPoints
            ...
            if element2.value == "view" then
                ...
                ESX.OpenContext("right", elements3, function(menu3, element3)
                    ...
                    elseif element3.value == "buy" then
                        ...
                        ESX.TriggerServerCallback("bpt_governamentjob:buyJobVehicle", function(bought)
                            if bought then
