Locales["it"] = {
    -- bennys
    ["bennys"] = "bennys",
    ["open_bennys"] = "Premi [E] per accedere all'bennys.",
    ["confirm"] = "Conferma",
    -- Veicoli
    ...
    ["invalid_amount"] = "Errore: l'bennyso non era un numero o non era valido",
    ...
    ["quantity"] = "quantità",
    ["quantity_placeholder"] = "bennyso da prelevare..",
    ["inventory"] = "inventario",
    ["bennys_stock"] = "Deposito bennys",
    -- Varie
