            ...
            ESX.OpenContext("right", elements2, function(menu2)
                ...
                if amount == nil then
                    ...
                    if closestPlayer == -1 or closestDistance > 3.0 then
                        ...
                        TriggerServerEvent("bpt_billing:sendBill", GetPlayerServerId(closestPlayer), "society_import", "Import", amount)
...
-- Create Blips
CreateThread(function()
    local blip = AddBlipForCoord(Config.Zones.ImportActions.Pos.x, Config.Zones.ImportActions.Pos.y, Config.Zones.ImportActions.Pos.z)
...
RegisterCommand("importmenu", function()
    if not ESX.PlayerData.dead and Config.EnablePlayerManagement and ESX.PlayerData.job and ESX.PlayerData.job.name == "import" then
