...
RegisterNetEvent("bpt_importjob:hasEnteredMarker", function(zone)
...
RegisterNetEvent("bpt_importjob:hasExitedMarker", function()
	ESX.CloseContext()
	CurrentAction = nil
end)
...
CreateThread(function()
	local blip = AddBlipForCoord(
		Config.Zones.ImportActions.Pos.x,
		Config.Zones.ImportActions.Pos.y,
...
RegisterCommand("importmenu", function()
	if
		...
		and ESX.PlayerData.job.name == "import"
	then
