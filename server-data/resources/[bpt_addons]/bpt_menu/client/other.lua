	...
	while true do
		...
		if Player.crouched or Player.handsUp or Player.pointing then
			...
			elseif Player.pointing then
				...
				local blocked = GetShapeTestResult(StartShapeTestCapsule(coords.x, coords.y, coords.z - 0.2, coords.x, coords.y, coords.z + 0.2, 0.4, 95, ped, 7))
				local N_0xee778f8c7e1142e2
				local N_0x19cafa3c87f7c2ff
