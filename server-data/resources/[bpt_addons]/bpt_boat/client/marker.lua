...
AddEventHandler("bpt_boat:hasEnteredMarker", function(zone, zoneNum)
...
AddEventHandler("bpt_boat:hasExitedMarker", function()
...
CreateThread(function()
    while true do
        ...
        if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastZone ~= currentZone or LastZoneNum ~= currentZoneNum)) then
            ...
            TriggerEvent("bpt_boat:hasEnteredMarker", currentZone, currentZoneNum)
        end

        if not hasExited and not isInMarker and HasAlreadyEnteredMarker then
            HasAlreadyEnteredMarker = false
            TriggerEvent("bpt_boat:hasExitedMarker")
        end
