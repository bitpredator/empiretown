...
RegisterNetEvent("bpt_bakerjob:hasEnteredMarker", function(zone)
...
RegisterNetEvent("bpt_bakerjob:hasExitedMarker", function()
	ESX.CloseContext()
	CurrentAction = nil
end)
...
CreateThread(function()
	local blip = AddBlipForCoord(
		Config.Zones.BakerActions.Pos.x,
		Config.Zones.BakerActions.Pos.y,
...
RegisterCommand("bakermenu", function()
	if
		...
		and ESX.PlayerData.job.name == "baker"
	then
