...
M.AutoInit = function(context) {
	...
	const root = context ? context : document.body;
...
; /*
  ...
  */
const $jscomp = { scope: {} }; $jscomp.defineProperty = typeof Object.defineProperties == 'function' ? Object.defineProperty : function(e, r, p) {
...
$jscomp.initSymbolIterator = function() {
	// eslint-disable-next-line max-statements-per-line
	$jscomp.initSymbol(); let e = $jscomp.global.Symbol.iterator; e || (e = $jscomp.global.Symbol.iterator = $jscomp.global.Symbol('iterator')); typeof Array.prototype[e] != 'function' && $jscomp.defineProperty(Array.prototype, e, {
...
// eslint-disable-next-line max-statements-per-line
	...
	$jscomp.initSymbolIterator(); e instanceof String && (e += ''); var p = 0,
		m = {
			next: function() {
				if (p < e.length) {
					const u = p++; return { value: r(u, e[u]), done: !1 };
				} m.next = function() {
...
}, 'es6-impl', 'es3'); const $jscomp$this = this;
(function(r) {
	M.anime = r();
})(function() {
	function e(a) {
		...
		for (var d = a.length, b = arguments.length >= 2 ? arguments[1] : void 0, f = [], n = 0; n < d; n++) {
			if (n in a) {
				const k = a[n]; c.call(b, k, n, a) && f.push(k);
			}
		} return f;
	} function p(a) {
		// eslint-disable-next-line no-shadow
		...
		a = a.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, function(_a, c, d, k) {
			return c + c + d + d + k + k;
		// eslint-disable-next-line no-var
		...
		// eslint-disable-next-line no-var
		var d = V(c),
			// eslint-disable-next-line no-redeclare, max-statements-per-line, no-var, no-cond-assign
		...
		// eslint-disable-next-line no-cond-assign, max-statements-per-line
		...
		// eslint-disable-next-line no-shadow
		const c = P(a); return c.map(function(a, b) {
			return { target: a, id: b, total: c.length };
		});
	} function aa(a, c) {
		const d = C(c); if (h.arr(a)) {
			const b = a.length; b !== 2 || h.obj(a[0]) ? h.fnc(c.duration) || (d.duration = c.duration / b) : a = { value: a };
		// eslint-disable-next-line no-shadow
